...
Page({
  ...
  onShow: function () {//这里用成生命周期函数了//
    ...
    wx.request({
      ...
      url: 'https://api.map.baidu.com/telematics/v3/weather?location=' + "阿坝藏族羌族自治州" + '&output=json&ak=' + theBaiDuAPPkey, //百度天气API
    ...
    wx.request({
      ...
      url: 'https://api.map.baidu.com/telematics/v3/weather?location=' + "呼伦贝尔" + '&output=json&ak=' + theBaiDuAPPkey, //百度天气API
    ...
    wx.request({
      ...
      url: 'https://api.map.baidu.com/telematics/v3/weather?location=' + "十堰" + '&output=json&ak=' + theBaiDuAPPkey, //百度天气API
    ...
    wx.request({
      ...
      url: 'https://api.map.baidu.com/telematics/v3/weather?location=' + "吉林" + '&output=json&ak=' + theBaiDuAPPkey, //百度天气API
    ...
    wx.request({
      ...
      url: 'https://api.map.baidu.com/telematics/v3/weather?location=' + "香格里拉" + '&output=json&ak=' + theBaiDuAPPkey, //百度天气API
    ...
    wx.request({
      ...
      url: 'https://api.map.baidu.com/telematics/v3/weather?location=' + "焦作" + '&output=json&ak=' + theBaiDuAPPkey, //百度天气API
