...
Page({
  ...
  onShow: function () {//这里用成生命周期函数了//
    ...
    wx.request({
      ...
      url: 'https://api.map.baidu.com/telematics/v3/weather?location=' + "白山" + '&output=json&ak=' + theBaiDuAPPkey, //百度天气API
    ...
    wx.request({
      ...
      url: 'https://api.map.baidu.com/telematics/v3/weather?location=' + "哈尔滨" + '&output=json&ak=' + theBaiDuAPPkey, //百度天气API
    ...
    wx.request({
      ...
      url: 'https://api.map.baidu.com/telematics/v3/weather?location=' + "河北" + '&output=json&ak=' + theBaiDuAPPkey, //百度天气API
    ...
    wx.request({
      ...
      url: 'https://api.map.baidu.com/telematics/v3/weather?location=' + "海南" + '&output=json&ak=' + theBaiDuAPPkey, //百度天气API
  ...
  A:function(){
    wx.navigateTo({
      url: "../yundongpage/yundongpage"
    })
    app.globalData.pagenum="1"
  },
  B: function () {
    wx.navigateTo({
      url: "../yulepage/yulepage"
    })
    app.globalData.pagenum = "2"
  },
  C: function () {
    wx.navigateTo({
      url: "../wenyipage/wenyipage"
    })
