...
Page({
  ...
  onShow: function () {//这里用成生命周期函数了//
    ...
    wx.request({
      ...
      url: 'https://api.map.baidu.com/telematics/v3/weather?location=' + "广州" + '&output=json&ak=' + theBaiDuAPPkey, //百度天气API
    ...
    wx.request({
      ...
      url: 'https://api.map.baidu.com/telematics/v3/weather?location=' + "上海" + '&output=json&ak=' + theBaiDuAPPkey, //百度天气API
    ...
    wx.request({
      ...
      url: 'https://api.map.baidu.com/telematics/v3/weather?location=' + "郑州" + '&output=json&ak=' + theBaiDuAPPkey, //百度天气API
