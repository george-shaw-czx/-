...
Page({
  ...
  onShow: function () {//这里用成生命周期函数了//
    ...
    wx.request({
      ...
      url: 'https://api.map.baidu.com/telematics/v3/weather?location=' + "厦门" + '&output=json&ak=' + theBaiDuAPPkey, //百度天气API
    ...
    wx.request({
      ...
      url: 'https://api.map.baidu.com/telematics/v3/weather?location=' + "嘉兴" + '&output=json&ak=' + theBaiDuAPPkey, //百度天气API
    ...
    wx.request({
      ...
      url: 'https://api.map.baidu.com/telematics/v3/weather?location=' + "杭州" + '&output=json&ak=' + theBaiDuAPPkey, //百度天气API
    ...
    wx.request({
      ...
      url: 'https://api.map.baidu.com/telematics/v3/weather?location=' + "凤凰县" + '&output=json&ak=' + theBaiDuAPPkey, //百度天气API
